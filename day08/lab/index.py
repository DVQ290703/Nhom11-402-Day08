...
CHUNK_SIZE = 256 #400       # tokens (ước lượng bằng số ký tự / 4)
CHUNK_OVERLAP = 64 #80     # tokens overlap giữa các chunk
...
def get_embedding(text: str) -> List[float]:
    ...
    Dùng local Sentence Transformers (không tốn phí API).
    """
